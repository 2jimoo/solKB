...
def tool_serpapi_search(query: str, num_results: int = 5, gl: str = "us", hl: str = "en") -> Dict[str, Any]:
...
def tool_jina_read_url(url: str, timeout_s: int = 30, clip_chars: int = 12000) -> Dict[str, Any]:
...
def build_tool_registry() -> ToolRegistry:
    ...
    tr.register(
        name="echo",
        func=tool_echo,
        description="Echo back text (debug utility).",
        parameters={
            "type": "object",
    ...
    tr.register(
        name="serpapi_search",
        func=tool_serpapi_search,
        description="Search the web via SerpApi (Google).",
        parameters={
            "type": "object",
            "properties": {
                "query": {"type": "string"},
